...
feed_list.append("http://www.nrc.nl/nieuws/categorie/beste-van-het-web/rss.php")
feed_list.append("http://www.wel.nl/feed")
feed_list.append("http://feeds.flabber.nl/flabbernl")
feed_list.append("http://www.geenstijl.nl/index.xml")
#feed_list.append("http://www.vkmag.com/magazine/rss_2.0")
#feed_list.append("http://www.retecool.com/feed/")
#feed_list.append("http://sargasso.nl/feed/")
feed_list.append("http://brekend.nl/feed")
feed_list.append("http://www.froot.nl/feed/")
feed_list.append("http://www.speld.nl/feed/")
feed_list.append("http://www.thepostonline.nl/feed/")
feed_list.append("http://feeds.endandit.nl/EnDanDit?format=xml")
feed_list.append("http://glamora.ma/index.xml")
feed_list.append("http://www.joop.nl/rsslinks/totaal/?type=100")
feed_list.append("http://feeds.feedburner.com/upcomingnl?format=xml")
