...
feed_list.append("http://www.nu.nl/feeds/rss/film.rss")
feed_list.append("http://www.biosagenda.nl/rss-filmniews.xml")
feed_list.append("http://feeds.feedburner.com/Filmtotaal-Filmnieuws")
feed_list.append("http://www.cinema.nl/feeds/artikelen/?articleType=NEWS")
feed_list.append("http://www.ad.nl/showbizz/film/rss.xml")
feed_list.append("http://www.nrc.nl/breedbeeld/rss.php?n=np")
feed_list.append("http://www.metronieuws.nl/rss.xml?c=1277377288-9")
feed_list.append("http://www.kijkbaar.nl/feed/")
feed_list.append("http://www.show.nl/f/rubrieken/film-rubrieken/feed/")
