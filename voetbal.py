...
feed_list.append("http://feeds.fcupdate.nl/nieuws.xml")
feed_list.append("http://www.voetbalprimeur.nl/rss.xml")
#feed_list.append("http://www.soccernews.nl/rss")
feed_list.append("http://www.vi.nl/web/feed/nieuws")
feed_list.append("http://www.goal.com/nl/feeds/news?fmt=rss&ICID=HP")
feed_list.append("http://www.nusport.nl/rss/voetbal")
feed_list.append("http://www.ad.nl/sportwereld/voetbal/rss.xml")
feed_list.append("http://feeds.elfvoetbal.nl/elfvoetbal-nieuws?format=xml")
feed_list.append("http://www.telegraaf.nl/rss/telesport.voetbal.xml")
feed_list.append("http://feeds.nos.nl/nosvoetbal?format=xml")
feed_list.append("http://voetbal.blog.nl/feed")
feed_list.append("http://www.voetbalzone.nl/rss/rss.xml")
feed_list.append("http://www.rtlnieuws.nl/service/rss/sport/voetbal/index.xml")
