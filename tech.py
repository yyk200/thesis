...
feed_list.append("http://feeds.webwereld.nl/webwereld")
feed_list.append("http://tweakers.net/feeds/mixed.xml")
feed_list.append("http://www.nutech.nl/rss")
feed_list.append("http://www.ad.nl/digitaal/rss.xml")
feed_list.append("http://www.bnr.nl/nieuws/tech/?widget=rssfeed&view=feed&contentId=1227456")
feed_list.append("http://www.telegraaf.nl/rss/digitaal.xml")
feed_list.append("http://www.elsevier.nl/Service/RSS/Feed/Tech/")
feed_list.append("http://www.computeridee.nl/feeds/nieuws/")
feed_list.append("http://www.metronieuws.nl/rss.xml?c=1283166782-12")
feed_list.append("http://feeds.feedburner.com/pcmweb_nieuws?format=xml")
feed_list.append("http://feeds.techzine.nl/techzine/nieuws")
feed_list.append("http://feeds.feedburner.com/websonic")
feed_list.append("http://www.spitsnieuws.nl/rss/tech/rss.xml")
feed_list.append("http://rss.feedsportal.com/c/32142/f/414032/index.rss")
feed_list.append("http://www.nu.nl/feeds/rss/tech.rss")
