...
feed_list.append("http://www.nu.nl/feeds/rss/economie.rss")
feed_list.append("http://www.telegraaf.nl/rss/dft.xml")
feed_list.append("http://www.ad.nl/geld/rss.xml")
feed_list.append("http://www.volkskrant.nl/nieuws/economie/rss.xml")
feed_list.append("http://www.trouw.nl/nieuws/economie/rss.xml")
feed_list.append("http://www.parool.nl/economie/rss.xml")
feed_list.append("http://www.nrc.nl/nieuws/categorie/economie/rss.php")
feed_list.append("http://www.metronieuws.nl/rss.xml?c=1278070988-0")
feed_list.append("http://www.bnr.nl/nieuws/beurs/?widget=rssfeed&view=feed&contentId=1227456")
feed_list.append("http://www.elsevier.nl/Service/RSS/Feed/Economie/")
feed_list.append("http://www.nieuws.nl/rss/economie")
feed_list.append("http://feeds.nos.nl/nosnieuwseconomie?format=xml")
feed_list.append("http://www.rtlnieuws.nl/service/rss/economie/home/index.xml")
