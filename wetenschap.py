...
feed_list.append("http://www.nrc.nl/nieuws/categorie/wetenschap/rss.php")
feed_list.append("http://www.scienceguide.nl/rss.aspx?id=1089")
feed_list.append("http://www.nu.nl/feeds/rss/wetenschap.rss")
feed_list.append("http://www.wetenschap24.nl/rss/?generatorName=wetenschap-nieuws")
feed_list.append("http://www.scientias.nl/feed")
feed_list.append("http://nieuws.nl.msn.com/rss/wetenschap_rss.aspx")
feed_list.append("http://www.newscientist.nl/feed/")
feed_list.append("http://www.ad.nl/wetenschap/rss.xml")
feed_list.append("http://www.kennislink.nl/publicaties.atom")
feed_list.append("http://www.volkskrant.nl/nieuws/gezondheid--wetenschap/rss.xml")
feed_list.append("http://wetenschap.blog.nl/feed")
