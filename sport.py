...
feed_list.append("http://www.nu.nl/feeds/rss/sport.rss")
feed_list.append("http://www.telegraaf.nl/rss/telesport.xml")
feed_list.append("http://www.ad.nl/sportwereld/rss.xml")
feed_list.append("http://www.bnr.nl/radio/bnr-sportzaken/?widget=rssfeed&view=feed&contentId=1227456")
feed_list.append("http://www.volkskrant.nl/sport/rss.xml")
feed_list.append("http://www.elsevier.nl/Service/RSS/Feed/Sport/")
feed_list.append("http://feeds.sportupdate.nl/nieuws.xml")
feed_list.append("http://www.nieuws.nl/rss/sport")
feed_list.append("http://feeds.feedburner.com/nossportalgemeen?format=xml")
feed_list.append("http://www.rtlnieuws.nl/service/rss/sport/algemeen/index.xml")
feed_list.append("http://www.spitsnieuws.nl/rss/sport/rss.xml")
feed_list.append("http://www.nrc.nl/nieuws/categorie/sport/rss.php")
feed_list.append("http://www.parool.nl/sport/rss.xml")
